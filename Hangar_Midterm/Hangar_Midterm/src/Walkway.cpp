...
void Walkway::Load()
{
	...
	SetCurrentModel("Assets/Models/Walkway/SM_Env_Construction_Block_01_xyz_n_rgba_uv_flatshaded_xyz_n_uv.ply",
	...
	//Bridge Rail
	SetCurrentModel("Assets/Models/Walkway/SM_Env_Construction_Rail_01_xyz_n_rgba_uv_flatshaded_xyz_n_uv.ply",
	...
	//TopConnecting Rail
	SetCurrentModel("Assets/Models/Walkway/SM_Env_Construction_Rail_03_xyz_n_rgba_uv_flatshaded_xyz_n_uv.ply",
		glm::vec3(0.0f, 180.0f, 0.0f));
	...
	//Stairs
	SetCurrentModel("Assets/Models/Walkway/SM_Env_Construction_Stairs_01_xyz_n_rgba_uv_flatshaded_xyz_n_uv.ply",
		glm::vec3(0.0f, 0.0f, 0.0f));
	...
	//Doorway
	SetCurrentModel("Assets/Models/Walkway/SM_Env_ControlRoom_Doorway_01_xyz_n_rgba_uv_flatshaded_xyz_n_uv.ply",
		glm::vec3(0.0f, 0.0f, 0.0f));

	AddModelPos({ 40.0f,15.0f, 40.0f });

	//Door
	SetCurrentModel("Assets/Models/Walkway/SM_Env_ControlRoom_Door_01_xyz_n_rgba_uv_flatshaded_xyz_n_uv.ply",
		glm::vec3(0.0f, 180.0f, 0.0f));
